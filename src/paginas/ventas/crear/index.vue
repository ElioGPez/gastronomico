      ...
      <CCol sm="12" md="12">
        <CCard>
          <CCardBody>
            ...
            <CRow>
              <CCol align="center" sm="2" class="col-form-label">
                <h6>CLIENTE</h6>             
              </CCol>
              <CCol sm="3">
                    <CInput
              ...
              <CCol  align="right" class="col-form-label">
                <h4 style="color:green" class="total">TOTAL ${{total}}</h4>
              </CCol>
            </CRow>
          </CCardBody>
        </CCard>
    ...
    >
      <div class="card">
        <CCol tag="label" sm="12" class="col-form-label">
          <CInput v-model="filtro" label="Nombre o Codigo" horizontal autocomplete="producto" />
        </CCol>
        <CCol sm="12">
          <CTableWrapper
            :items="filtroListado"
...
export default {
  ...
  computed: {
    getLineas(){
      ...
      filtroListado(){
            var cat = this.lista_productos.filter((item) => 
            {
